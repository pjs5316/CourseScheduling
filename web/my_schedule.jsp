...
<%-- 
    Document   : myschedule
    Created on : Feb 15, 2016, 7:27:27 PM
    Author     : jakesemple
--%>
...
<html>
    ...
    <sql:query var="reg" dataSource="jdbc/courseSchedule">
        SELECT Course_Code, Description, Credits, Pre_req, Semester, 
            ...
            FROM registration, section, course 
            Where registration.section_Section_ID= section.Section_ID
    </sql:query>
        ...
        <table border="0">
            ...
            <td>
                <form action="browse.jsp">
                    <c:forEach var="row" items="${reg.rowsByIndex}">
        ...
        <table border="0">
            ...
            <c:forEach var="section" items="${sectionList}">
                <tr>
                    ...
                    <td>
                        <a href="/deleteSection?id=${section.sectionID}">Remove</a></td>
